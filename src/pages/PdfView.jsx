...
export default function PdfView() {
  ...
  if (state.error) return <div className="card p-8 text-center"><div className="text-4xl mb-3">🔒</div><p>This document could not be opened.</p><p className="text-sm text-ink/70 mt-2">{state.error.message || 'Please try again.'}</p><Link className="btn-secondary inline-flex mt-4" to={back}>Go back</Link></div>
